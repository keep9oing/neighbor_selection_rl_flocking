"""Trial 1: Resume sf=0.05 from iter-100 checkpoint, lr=2e-4, Adam state kept."""
import copy
...
RESTORE_CKPT = (
    "/workspace/test_results/scale_factor_sweep_260521/"
    "GradLoggingPPO_neighbor_selection_flocking_env_b6e42_00001_1_"
    "scale_factor=0.0500_2026-05-21_13-26-55/checkpoint_000100"
)
