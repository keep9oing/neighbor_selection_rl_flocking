"""Single trial: w_ctrl=0.5, sf=0.15, entropy_coeff=0, lr_schedule, clip=0.15.
Tests if w_ctrl alone prevents FC convergence without entropy regularization."""
import copy
import ray
...
if __name__ == "__main__":
    ...
    my_config.env.acs_train_w_ctrl = 0.5
