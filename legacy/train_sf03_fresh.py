"""Trial 2: Fresh start sf=0.03, lr schedule 5e-4 -> 2e-4 over 50 iters."""
import copy
...
if __name__ == "__main__":
    ...
    # lr schedule: 5e-4 -> 2e-4 over ~50 iters (800K timesteps), then hold 2e-4.
    # Higher initial lr accelerates cold-start exploration; sf=0.03's gentle
    # logit scale keeps it stable at 5e-4.
    tune.run(
        GradLoggingPPO,
        name="sf03_fresh_lr2e4_260522",
        ...
        config={
            ...
            "num_sgd_iter": 10,
            "lr": 2e-4,
            "lr_schedule": [[0, 5e-4], [800000, 2e-4]],
            "vf_loss_coeff": 0.5,
            "use_critic": True,
            "use_gae": True,
            "gamma": 0.99,
