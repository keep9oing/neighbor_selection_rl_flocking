"""RL fine-tuning from BC-pretrained model (no distance bias, no top-K).
The model's weights encode KNN behavior from BC. RL should improve by
learning to use heading info that KNN ignores."""
import ray
        ...
        config={
            ...
            "model": {
                ...
                "custom_model_config": {
                    ...
                    "pretrained_weights_path": "/workspace/test_results/bc_knn_weights.pt",
                },
            },
            "num_gpus": 0.5,
            "num_workers": 4,
