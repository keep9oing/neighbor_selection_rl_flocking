"""Conservative trial: sf=0.10, w_ctrl=0.3, clip=0.1, lr=3e-4.
sf=0.10 showed no learning with w_ctrl=0.02, but the stronger w_ctrl reward should
provide enough gradient signal at this safer scale factor. Lower clip and lr prevent
the overshoot seen with sf=0.15 + w_ctrl=0.5."""
import copy
import ray
...
if __name__ == "__main__":
    ...
    my_config.env.acs_train_w_ctrl = 0.3
    ...
    # 2 trials: sf=0.10 + sf=0.12 with w_ctrl=0.3
    tune.run(
        GradLoggingPPO,
        name="stable_wctrl_260523",
        ...
        config={
            ...
            "model": {
                ...
                "custom_model_config": {
                    **custom_model_config,
                    "scale_factor": tune.grid_search([0.10, 0.12]),
                },
            },
            "num_gpus": 0.5,
            "num_workers": 4,
