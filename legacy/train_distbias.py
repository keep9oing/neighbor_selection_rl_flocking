"""Distance-biased attention: base behavior = K-nearest.
The attention scores get a permanent -scale*dist² bias. At init (learned scores≈0),
the policy selects nearest neighbors. The model learns corrections on top.
No top-K constraint — the distance bias naturally suppresses distant neighbors.
w_ctrl=0.02 (original) since the base behavior is already better than FC."""
import ray
