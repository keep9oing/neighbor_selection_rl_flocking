"""sf=0.15 with large batch: train_batch_size=64000 (4x default).
More samples per update = lower gradient variance = more stable learning.
Combined with w_ctrl=0.2, clip=0.1, num_sgd_iter=5, lr=3e-4.
Uses 16 workers to collect enough data for the large batch."""
import copy
import ray
...
if __name__ == "__main__":
    ...
    tune.run(
        ...
        config={
            ...
            "num_sgd_iter": 5,
            "lr": 3e-4,
            "lr_schedule": [[0, 3e-4], [3200000, 5e-5]],
            "vf_loss_coeff": 0.5,
            "use_critic": True,
            "use_gae": True,
            "gamma": 0.99,
