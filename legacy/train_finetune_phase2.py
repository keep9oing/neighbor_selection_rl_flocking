"""Phase 2: Continue from softened-FC checkpoint with entropy_coeff=0.
Phase 1 broke out of FC determinism (entropy 13→216) while maintaining FC topology.
Now train with w_ctrl=0.2, entropy_coeff=0 to learn genuine selectivity."""
import copy
import ray
...
if __name__ == "__main__":
    ...
    checkpoint_path = ("/workspace/test_results/finetune_fc_260523/"
                       "GradLoggingPPO_neighbor_selection_flocking_env_1e9ff_00000_0_"
                       "2026-05-23_03-26-00/checkpoint_000071")

    tune.run(
        GradLoggingPPO,
        name="finetune_phase2_260523",
